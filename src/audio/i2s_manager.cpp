...
bool I2SManager::beginMicrophone(uint32_t sampleRate, i2s_bits_per_sample_t bitsPerSample) {
    ...
    i2s_config_t i2s_config = {
        ...
        .channel_format = I2S_CHANNEL_FMT_ONLY_LEFT,  // LEFT channel is correct
        .communication_format = I2S_COMM_FORMAT_STAND_I2S,  // Back to standard I2S
        .intr_alloc_flags = ESP_INTR_FLAG_LEVEL1,
        .dma_buf_count = I2S_DMA_BUF_COUNT,
        .dma_buf_len = I2S_DMA_BUF_LEN,
        .use_apll = true,   // Back to APLL
